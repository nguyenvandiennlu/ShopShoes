...
<!-- Enhanced Image Zoom & Lazy Loading -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/product-image-zoom.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/quick-view.css" />
